...
class SportsmonksClient:
    ...
    def get_fixtures_for_tactical_analysis(
        ...
        """
        Fetch completed fixtures with full statistics for tactical aggregation.
        ...
        Confirmed fixture stat structure (API diagnostic Feb 2026):
            ...
            stat["type"]["code"]     stat code string  (requires .type include)
        ...
        # Only completed fixtures — those that have scores populated
